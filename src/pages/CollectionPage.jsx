...
const CollectionPage = () => {
  ...
  if (loading) {
    return (
      <main className="relative z-10 pt-28 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
  ...
  if (error || !collection) {
    return (
      <main className="relative z-10 pt-28 pb-20 px-6 max-w-7xl mx-auto min-h-screen text-center">
        <h1 className="font-pixel text-3xl text-red-400 mb-4">NOT FOUND</h1>
    ...
    <main className="relative z-10 pt-28 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="text-center mb-16">
        <div className="flex items-center mb-6">
          ...
          <h1 className="mx-8 text-4xl md:text-5xl font-pixel text-red-500 drop-shadow-[0_0_15px_rgba(255,0,0,0.5)]">
