  ...
  return (
    <main className="relative z-10 pt-24 sm:pt-28 pb-20 px-4 max-w-2xl mx-auto min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="bg-dark-surface border border-white/10 rounded-2xl p-6 sm:p-8 space-y-5">
        ...
        <div className="bg-red-500/10 border border-red-500/40 rounded-xl p-4 sm:p-5">
          <div className="flex items-start gap-3">
            <span className="text-xl shrink-0 mt-0.5">⚠️</span>
            <div className="flex-1">
              <p className="text-red-400 font-bold text-sm sm:text-base mb-1 uppercase tracking-wide">
                Must join Creator Server before filling application
              </p>
              <p className="text-gray-400 text-xs sm:text-sm leading-relaxed mb-3">
                Creator needs to join the Redline SMP Creator server before processing their application,
                or else their application won't be reviewed.
              </p>
              <a
                href="https://discord.gg/DPZ57hXdcM"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#5865F2]/20 border border-[#5865F2]/50 text-[#7289da] hover:bg-[#5865F2]/30 hover:border-[#5865F2]/70 transition-all text-xs font-semibold"
              >
